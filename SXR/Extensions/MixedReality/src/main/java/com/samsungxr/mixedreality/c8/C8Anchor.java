...
/**
 * Represents a C8 anchor in the scene.
 *
 */
public class C8Anchor extends SXRAnchor {
    private Anchor mAnchor;
    private C8Pose mPose;

    protected C8Anchor(SXRContext gvrContext) {
        super(gvrContext);
        mPose = new C8Pose();
    }
     ...
     * Sets C8 anchor
     *
     * @param anchor C8 Anchor instance
     */
